...
public class PointEditorFragment extends QuestionEditorFragment {
    MapView mMap;
    ...
    public boolean validate(){
        ...
        TextView maxPointsView = getView().findViewById(R.id.max_points);
        if (Integer.valueOf(maxPointsView.getText().toString()) <= 0){
            error = "El número de puntos agregables debe ser mayor a 0.\n";
        }
    ...
    public Map<String, Object> getOptions(){
        ...
        TextView maxPointsView = getView().findViewById(R.id.max_points);
        map.put("max", Integer.valueOf(maxPointsView.getText().toString()));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_point, null);
