...
public class SettingsActivity extends AppCompatPreferenceActivity {
            ...
            if (preference instanceof ListPreference) {
                ...
                preference.setSummary(
                        index >= 0
                                ...
                                : null);
                if (preference.getKey().equals("pref_lang")) {
                    Locale locale = new Locale(((ListPreference) preference).getValue());
     ...
     */
    private static void bindPreferenceSummaryToValue(Preference preference, final Context context) {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("pref_lang"), getActivity());
        }
